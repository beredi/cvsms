...
class StockItemController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.stock.index', ['items' => StockItem::all()->sortByDesc('id')]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validated){
            ...
            session()->flash('stock-item-created', __('messages.admin.menu.stock.created-item'));
        }
    ...
    public function update(Request $request, StockItem $stockItem)
    {
        ...
        if ($validated){
            ...
            session()->flash('stock-item-updated', __('messages.admin.menu.stock.updated-item'));
    ...
    public function destroy(Request $request)
    {
        ...
        $stockItem->delete();
        session()->flash('stock-item-deleted', __('messages.admin.menu.stock.deleted-item'));
