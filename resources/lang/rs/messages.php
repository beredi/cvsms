...
return [
    "admin" => [
            ...
            "services" => [
                ...
                "messages" => [
                    ...
                    "items-already-attached" =>
                        "Sledeći delovi su već uračunati u servis: ",
                    "items-qty-not-fit" =>
                        "Nema dovoljno komada na lageru za sledeće delove: ",
                ],
                "add-stock-items" => "Dodaj stvari sa skladišta",
                "parts" => "Delovi",
            ],
            "customers" => [
                "name" => "Mušterija",
                ...
                "delete_customer" =>
                    "Da li si siguran da želiš da obrišeš mušteriju: :name :lastname ?",
                "deleted_customer" =>
                    "Mušterija :name :lastname je uspešno obrisana.",
                "updated_customer" =>
                    "Mušterija :name :lastname je uspešno ažurirana.",
                "created_customer" =>
                    "Mušterija :name :lastname je uspešno dodata.",
            ],
            "employees" => [
                "name" => "Radnik",
                "plural_name" => "Radnici",
                ...
                "delete_employee" =>
                    "Da li si siguran da želiš da obrišeš zaposlenog: :name :lastname ?",
                "deleted_employee" =>
                    "Radnik :name :lastname je uspešno obrisan.",
                "created_employee" =>
                    "Radnik :name :lastname je uspešno dodat.",
                "updated_employee" =>
                    "Radnik :name :lastname je uspešno ažuriran.",
            ],
            "user" => [
                "name" => "Zaposlen",
                ...
                "logout_m" =>
                    'Klinki "Odjavi se" ispod ako želiš da se odjaviš.',
            ],
            "stock" => [
                "name" => "Skladište",
                ...
                "item" => [
                    ...
                    "pieces" => "Komada",
                    "detach-item" => "Ukloni deo iz servisa",
                ],
        ...
        "validator" => [
            ...
            "positive_number" =>
                "Vrednost polja :field mora da bude pozitivan broj.",
            "unique" =>
                "Vrednost polja :field se već koristi. Mora da bude unikat.",
            "min" =>
                "Vrednost polja :field mora da sadrži najmanje :count znakova.",
        ],
        "permissions" => [
            "name" => "Dozvole",
