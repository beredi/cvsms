<li class="nav-item dropdown no-arrow">
    <a class="nav-link dropdown-toggle user" href="#" id="userDropdown" role="button"
       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <span class="user mr-2 d-none d-lg-inline small"><strong>{{\Illuminate\Support\Facades\Auth::user()->name}}</strong> | {{\Illuminate\Support\Facades\Auth::user()->role->name}} <i class="fas fa-caret-down"></i></span>
    </a>
